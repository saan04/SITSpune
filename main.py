    ...
    if result:
        ...
        if outputs.multi_face_landmarks:
            ...
            if frame_count > min_frame:
                message = 'Drowsiness Alert: It seems you are sleepy.. Wake up!'
                t = threading.Thread(target=perform_speech(message))  # create new instance if thread is dead
                t.start()
            ...
            if ratio_lips < 1.8:
                message = 'Drowsiness Warning: You looks tired.. Please take rest'
                p = threading.Thread(target=perform_speech(message))  # create new instance if thread is dead
                p.start()
